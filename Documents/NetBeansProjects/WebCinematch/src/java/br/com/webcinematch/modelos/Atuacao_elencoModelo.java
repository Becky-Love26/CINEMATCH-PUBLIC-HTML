// Atuacao_elencoModelo.java
package br.com.webcinematch.modelos;

import java.util.ArrayList;
import br.com.webcinematch.daos.Atuacao_elenco;
import br.com.webcinematch.conexao.ConexaoMySQL;
import java.sql.*;
import java.util.logging.Level;
import java.util.logging.Logger;

public class Atuacao_elencoModelo {

    public Atuacao_elencoModelo() {
    }
    ...
    public ArrayList<Atuacao_elenco> consultarAtuacoes() {
        ...
        try {
            ...
            Logger.getLogger(Atuacao_elencoModelo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String[] args) {
        Atuacao_elencoModelo aec = new Atuacao_elencoModelo();
