...
import br.com.webcinematch.daos.Plano_filme;
...
public class Plano_filmeModelo {
    ...
    public ArrayList<Plano_filme> listar() {
        ...
        try {
            ...
            Logger.getLogger(Plano_filmeModelo.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try { if (rs != null) rs.close(); } catch (SQLException e) {}
            try { if (stm != null) stm.close(); } catch (SQLException e) {}
            fecharConexao(conn);
    ...
    public static void main(String[] args) {
        Plano_filmeModelo pfc = new Plano_filmeModelo();
