...
import br.com.webcinematch.daos.Filme_avaliados;
import br.com.webcinematch.daos.Filme;
import br.com.webcinematch.daos.Perfil;
import br.com.webcinematch.conexao.ConexaoMySQL;
import java.sql.*;
import java.util.logging.Level;
import java.util.logging.Logger;

public class Filme_avaliadosModelo {
    ...
    private void fecharConexao(Connection conn) {
        try {
            ...
            Logger.getLogger(Filme_avaliadosModelo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
