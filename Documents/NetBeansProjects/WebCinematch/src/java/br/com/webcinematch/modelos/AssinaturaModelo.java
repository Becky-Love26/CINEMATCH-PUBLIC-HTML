...
import br.com.webcinematch.daos.Assinatura_plano;
import br.com.webcinematch.daos.Usuario;
import br.com.webcinematch.daos.Plano;
...
public class AssinaturaModelo {
    ...
    public ArrayList<Assinatura_plano> consultarAssinaturas() {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                ass.setID_Plano(new PlanoModelo().consultarPlanoCodigo(resultado.getInt("ID_Plano")));
                ass.setID_Usuario(new UsuarioControle().consultarUsuarioCodigo(resultado.getInt("ID_Usuario")));
                vAssinaturas.add(ass);
            }
        } catch (SQLException ex) {
            Logger.getLogger(AssinaturaModelo.class.getName()).log(Level.SEVERE, null, ex);
        }
        return vAssinaturas;
    }
    ...
    public Plano consultarPlanoPorUsuario(int idUsuario) {
        ...
        try {
            ...
            if (resultado.next()) {
                plano = new PlanoModelo().consultarPlanoCodigo(resultado.getInt("ID_Plano"));
            }
        } catch (SQLException ex) {
            Logger.getLogger(AssinaturaModelo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String[] args) {
        AssinaturaModelo ac = new AssinaturaModelo();
