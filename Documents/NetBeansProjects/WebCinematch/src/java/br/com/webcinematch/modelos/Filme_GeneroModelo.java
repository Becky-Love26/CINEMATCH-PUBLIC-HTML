package br.com.webcinematch.modelos;

import java.util.ArrayList;
import br.com.webcinematch.daos.Filme_genero;
import br.com.webcinematch.daos.Filme;
import br.com.webcinematch.daos.Genero;
import br.com.webcinematch.conexao.ConexaoMySQL;
import java.sql.*;
import java.util.logging.Level;
import java.util.logging.Logger;

public class Filme_GeneroModelo{

    public Filme_GeneroModelo() {
    }
    ...
    public ArrayList<Filme_genero> consultarFilme_genero() {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                fg.setID_Genero(new GeneroModelo().consultarID_Genero(resultado.getInt("ID_Genero")));
                fg.setID_Filme(new FilmeModelo().consultarFilmeCodigo(resultado.getInt("ID_Filme")));
                vFilme_genero.add(fg);
            }
           
        } catch (SQLException ex) {
            Logger.getLogger(ElencoModelo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public Filme_genero consultarID_Filme_Genero(int ID_Filme_Genero) {
        ...
        try {
            ...
            Logger.getLogger(Filme_GeneroModelo.class.getName()).log(Level.SEVERE, null, ex);
        }
        return fg;
    }
    ...
    Filme_GeneroModelo fgc = new Filme_GeneroModelo();
    ...
    novoFG.setID_Genero(new GeneroModelo().consultarID_Genero(1));
    novoFG.setID_Filme(new FilmeModelo().consultarFilmeCodigo(1));
...
for (Filme_genero fg : generos) {
    ...
    if(fgCons.getID_Filme_Genero() > 0) {
        ...
        fgCons.setID_Genero(new GeneroModelo().consultarID_Genero(2));
