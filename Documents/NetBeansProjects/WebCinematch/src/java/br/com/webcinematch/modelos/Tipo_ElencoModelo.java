...
import br.com.webcinematch.daos.Tipo_elenco; 
import br.com.webcinematch.conexao.ConexaoMySQL;
import java.sql.*;
import java.util.logging.Level;
import java.util.logging.Logger;

public class Tipo_ElencoModelo {

    public Tipo_ElencoModelo() {
    }
    ...
    public ArrayList<Tipo_elenco> consultarTiposElenco() {
        ...
        try {
            ...
            Logger.getLogger(Tipo_ElencoModelo.class.getName()).log(Level.SEVERE, null, ex);
        }
...
public static void main(String[] args) {
    Tipo_ElencoModelo tec = new Tipo_ElencoModelo();
