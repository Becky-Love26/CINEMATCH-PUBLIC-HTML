...
import br.com.webcinematch.daos.Filme_assistidos;
import br.com.webcinematch.conexao.ConexaoMySQL;
import java.sql.*;
import java.util.logging.Level;
import java.util.logging.Logger;

public class Filme_AssistidosModelo {

    public Filme_AssistidosModelo() {
    }
   ...
   public ArrayList<Filme_assistidos> consultarFilme_assistidos() {
    ...
    try {
        ...
        while (resultado.next()) {
            ...
            br.com.webcinematch.daos.Filme f = new br.com.webcinematch.daos.Filme();
            f.setID_Filme(resultado.getInt("ID_Filme"));
            f.setNome_filme(resultado.getString("nome_filme"));
            fa.setID_Filme(f);

            br.com.webcinematch.daos.Perfil p = new br.com.webcinematch.daos.Perfil();
        ...
        Logger.getLogger(Filme_AssistidosModelo.class.getName()).log(Level.SEVERE, null, ex);
    } 
    ...
    public Filme_assistidos consultarID_Filme_assistidos(int id_assistidos) {
        ...
        try (Connection conn = conexao.conectar();
            ...
            while (resultado.next()) {
                fa.setID_Assistidos(resultado.getInt("ID_Assistidos"));
                fa.setData_assistido(resultado.getDate("data_assistido"));
                fa.setID_Filme(new FilmeModelo().consultarFilmeCodigo(resultado.getInt("ID_Filme")));
                fa.setID_Perfil(new PerfilModelo().consultarPerfilCodigo(resultado.getInt("ID_Perfil")));
            }
    ...
    public static void main(String[] args) {
        Filme_AssistidosModelo fac = new Filme_AssistidosModelo();
