...
<head>
    ...
    <link rel="stylesheet" href="css/adm_filmes.css">
</head>
<body>
    <!-- Header -->
    <header>
        ...
        <nav class="nav-desktop">
            ...
            <a href="adm_usuario">USUÁRIOS</a>
            <a href="adm_filmes" id="selecionado">FILMES</a>
        </nav>
    </header>
    ...
    <div class="container">
        ...
        <div class="movie-list" id="movieList">
            <!-- Filmes serão carregados dinamicamente pelo backend -->
        </div>
    </div>
    ...
    <script>
        // Dados dos filmes carregados pelo backend
        let filmesData = [];
        ...
        searchInput.addEventListener('input', (e) => {
            ...
            searchTimeout = setTimeout(() => {
                ...
                window.location.href = `adm_filmes?busca=${encodeURIComponent(busca)}`;
            }, 500);
        });
        ...
        function aplicarFiltro() {
            ...
            window.location.href = `adm_filmes?filtro=${filtro}&busca=${encodeURIComponent(busca)}`;
        }
        ...
        function carregarAvaliacoes(idFilme) {
            fetch(`get_avaliacoes?id_filme=${idFilme}`)
        ...
        function verTodasAvaliacoes() {
            ...
            window.open(`avaliacoes?id_filme=${idFilme}`, '_blank');
        }
