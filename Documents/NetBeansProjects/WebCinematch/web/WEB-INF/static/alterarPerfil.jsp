...
<head>
    ...
    <title>CineMatch - Alterar Perfil</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/criarperfil.css">
</head>
<body>
    <header>
    ...
    <div class="back-button">
        <a href="home.htm" class="back-arrow">
            <img src="${pageContext.request.contextPath}/assets/img/" alt="Voltar">
        </a>
    </div>
    ...
    <div class="container">
        ...
        <div class="profile-section">
            <div class="avatar-wrapper">
                ...
                <a href="escolha_ft.htm?origem=alterar" class="edit-icon">
                    <img src="${pageContext.request.contextPath}/assets/img//lapis.png" alt="lapis editar" class="lapis" id="lapisid">
                </a>
            </div>
            
                <a href="escolha_perfil.htm" class="change-profile">
                    <img src="${pageContext.request.contextPath}/assets/img//setas.png" alt="setas alternar" class="setas" id="setasid"> ALTERNAR DE PERFIL
                </a>
        ...
        <form method="POST" action="">
            <div class="form-section">
                <div class="form-group">
                    <label class="form-label">Nome do Perfil (máx. 20 caracteres)</label>
